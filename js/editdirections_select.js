...
(function () {
	...
	jQuery(function () {
		...
		$( '#locations' ).change(function () {
			...
			$( '#posts' ).find( 'option:not(:first)' )	// Ищем все теги option, не являющиеся тегом по умолчанию
			...
			$.ajax({
				...
				url: "/editdirections/getselectdata",	// Путь к сценарию, обработающему запрос
				dataType: "json",	// Тип данных, в которых сервер должен прислать ответ
				data: "type_id=" + type_id,	// Строка POST-запроса
